...
import com.yuchai.itcommune.entity.Student1;
import com.yuchai.itcommune.entity.Student2;
...
public class ExcelController {
    ...
    public Result excel2Object2() throws Exception{
        String path = "D:\\workspace\\itcommune\\src\\main\\resources\\excelTemplate\\students_02.xlsx";
//        String path = ResourceUtils.CLASSPATH_URL_PREFIX + "excelTemplate/students_02.xlsx";
        // 1)
        ...
        return ResultUtil.genSuccessResult(students);
    }
    ...
    public Result excel2Object() throws Exception{
    ...
    public Result testList2Excel() throws Exception{
    ...
    public Result testObject2Excel() throws Exception{
    ...
    public Result testObject2BatchSheet() throws Exception{
    ...
    /**
     * 基于模板Map<String, Collection<Object.toString>>导出
     * @return
     * @throws Exception
     */
    @GetMapping(value = "/testMap2Excel")
    public Result testMap2Excel() throws Exception{
    ...
    public Result testBatchNoTemplate2Excel() throws Exception{
